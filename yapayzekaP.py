...
#Genek Ozellikler
#------------------------------------------------------------------------------
dataset = pd.read_csv('CarMarket.csv')
print('shape')
print(dataset.shape)
print('head')
print(dataset.head())
...
dataset3.drop(dataset3.loc[dataset3['Arac Tip Grubu']=='-'].index, inplace=True)
...
cols = ['Marka', 'Arac Tip Grubu','Model Yıl','Yakıt Turu', 'Vites', 'CCM', 'Renk', 'Kasa Tipi',
       'Kimden','Km']
